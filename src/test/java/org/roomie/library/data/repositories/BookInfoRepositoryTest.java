...
// import org.hillmerch.library.web.RoomieController;
// // import org.hillmerch.library.exception.BookInfoNotFoundException;
// import org.hillmerch.library.data.model.UserInfo;
...
// 	@Autowired
// 	UserInfoRepository bookInfoRepository;

// 	@Autowired
// 	RoomieController roomieController;
...
// 	// 		CreateTableRequest tableRequest = dynamoDBMapper.generateCreateTableRequest( UserInfo.class);
...
// 	// 	UserInfo productInfo = new UserInfo(EXPECTED_TITLE);
// 	// 	bookInfoRepository.save(productInfo);

// 	// 	List<UserInfo> result = (List<UserInfo>) userInfoRepository.findAll();
